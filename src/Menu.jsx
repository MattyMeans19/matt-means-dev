        ...
        <div id="menu" className={[`border-10 syscolor-Border bg-gray-200 rounded-t-4xl w-[15%] absolute z-30 bottom-12 h-[60%] ${props.active ? 'visible animate-fade-up animate-once animate-duration-250 animate-ease-linear' : 'hidden'} flex flex-col gap-10 py-10`]}>
            ...
            <div>
                ...
                <ul className={[`pl-5 text-[1.15rem] ${gamesView ? 'visible' : 'hidden'}`]}>
                    ...
                    <li className="flex flex-nowrap gap-2 cursor-default hover:bg-gray-300 active:bg-gray-500 rounded-full"><img src={GamesIcon} className="size-5"></img>Solitaire</li>
                </ul>
            </div>
            <div>
               ...
               <ul className={[`pl-5 text-[1.15rem] ${templatesView ? 'visible' : 'hidden'}`]}>
                    ...
                    <li className="flex flex-nowrap gap-2 cursor-default hover:bg-gray-300 active:bg-gray-500 rounded-full"><img src={MediaIcon} className="size-5"></img>Small-Business-Premium</li>
                </ul>
            </div>
