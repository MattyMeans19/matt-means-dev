...
function Menu(props){
    return(
        <div id="menu" className={[`border-10 border-green-700 bg-gray-200 rounded-t-4xl w-[15%] absolute z-30 bottom-12 h-[60%] ${props.active ? 'visible animate-fade-up animate-once animate-duration-500 animate-ease-linear' : 'hidden'} flex flex-col gap-10 py-10`]}>
