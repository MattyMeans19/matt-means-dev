...
function Banner(){
    return (
        <div className="mb-15 border-b-15 border-emerald-600 w-[95%] place-self-center bg-white rounded-2xl flex">
          <div className="basis-1/3">
            <h1 className="text-6xl ml-5">Matthew Means</h1>
            <h2 className="text-2xl ml-5 text-center">Full-Stack Web Developer 🌐</h2>
          </div>
          <div className="basis-2/3 w-full flex justify-around place-items-end text-2xl">
